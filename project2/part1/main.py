...
#print('SVM one vs. rest test_error:', run_svm_one_vs_rest_on_MNIST(0.1))
#print('SVM one vs. rest test_error:', run_svm_one_vs_rest_on_MNIST(0.2))
#print('SVM one vs. rest test_error:', run_svm_one_vs_rest_on_MNIST(0.5))
#print('SVM one vs. rest test_error:', run_svm_one_vs_rest_on_MNIST(0.8))
#print('SVM one vs. rest test_error:', run_svm_one_vs_rest_on_MNIST(1))
...
#See https://kehang.github.io/basic_project/2017/04/02/mnist-classifiers-exploration/
...
#print("Test error with PCA = ", test_error)
...
print("Test error 10 dim PCA and cubic features=", test_error)
